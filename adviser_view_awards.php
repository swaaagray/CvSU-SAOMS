...
$query = "
    ...
    WHERE a.organization_id = ? AND $statusCondition
";
...
<head>
    ...
    <title>View Awards - Organization Adviser</title>
    ...
    <style>
        ...
        .col-md-6:nth-child(even) .btn-outline-primary {
            border-color: #6c757d;
            color: #6c757d;
        }
        
        .col-md-6:nth-child(even) .btn-outline-primary:hover {
            background: linear-gradient(45deg, #6c757d, #868e96);
            border-color: #6c757d;
            color: white;
        ...
        .col-md-6:nth-child(even) .bi-trophy {
            color: #6c757d !important;
        }
    ...
    <main class="py-4">
        <div class="container-fluid">
            <div class="page-header">
                <h2 class="page-title">Organization Awards</h2>
                <p class="page-subtitle">View and manage your organization's awards</p>
            </div>
                    ...
                    <form method="GET" class="row g-3">
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                            <div class="d-grid gap-2 w-100">
                                ...
                                <a href="adviser_view_awards.php" class="btn btn-secondary">
