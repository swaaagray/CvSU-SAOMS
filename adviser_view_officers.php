...
// Get members scoped by organization with custom position ordering
$sql = "
    SELECT so.*, 
    CASE 
    ...
    <main class="main-content">
        <div class="container-fluid py-1">
            ...
            <div class="page-header">
                <h2 class="page-title">Organization Officers</h2>
                <p class="page-subtitle">View all officers and members of <?php echo htmlspecialchars($org['org_name']); ?></p>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body text-center py-5">
                                ...
                                <p class="text-muted mb-0">There are no officers registered for this organization yet.</p>
                            </div>
                        </div>
                    </div>
                <?php else: ?>
