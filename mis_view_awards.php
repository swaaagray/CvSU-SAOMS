...
<head>
    ...
    <title>View Awards - MIS Coordinator</title>
    ...
    <style>
        ...
        /* Special styling for award-specific elements */
        .text-warning {
            color: #495057 !important;
        }
        ...
        /* Award-specific enhancements */
        .row .col-md-6:nth-child(odd) .bi-trophy {
            color: #495057;
        }
                    ...
                    <form method="GET" class="row g-3">
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                            <div class="d-grid gap-2 w-100">
                                ...
                                <a href="mis_view_awards.php" class="btn btn-secondary">
                                ...
                                ?>
                                <a href="export_mis_awards.php?<?php echo $qs; ?>" class="btn btn-outline-secondary">
