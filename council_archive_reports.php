...
// Only allow council presidents and advisers
...
if ($councilId) {
    ...
    $collegeId = $council['college_id'] ?? null;
}
...
if ($councilId) {
    ...
    $stats = [
        ...
        'total_revenue' => array_sum(array_map(fn($fr) => (float)($fr['revenue'] ?? 0), $financialReports)),
        'total_expenses' => array_sum(array_map(fn($fr) => (float)($fr['expenses'] ?? 0), $financialReports)),
        'net_balance' => 0
    ];
...
<head>
    ...
    <title>Archive Reports - <?php echo htmlspecialchars($council['council_name'] ?? 'Council'); ?></title>
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="page-subtitle">View historical data from archived academic years (College-wide)</p>
                </div>
            ...
            <div class="filter-section">
                <form method="GET" action="council_archive_reports.php" class="row g-3">
                    <div class="col-md-4">
            ...
            <?php if ($reportType == 'events'): ?>
                <div class="archive-card card">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">Archived Events (College-wide)</h5>
                    </div>
                    <div class="card-body">
                        <?php if (empty($events)): ?>
            ...
            <?php if ($reportType == 'awards'): ?>
                <div class="archive-card card">
                    <div class="card-header bg-success text-white">
                        <h5 class="mb-0">Archived Awards (College-wide)</h5>
                    </div>
                    <div class="card-body">
                        <?php if (empty($awards)): ?>
            ...
            <?php if ($reportType == 'financial'): ?>
                <div class="archive-card card">
                    <div class="card-header bg-info text-white">
                        <h5 class="mb-0">Archived Financial Reports (College-wide)</h5>
                    </div>
                    <div class="card-body">
