...
// Build awards query
$query = "
    SELECT a.*, COALESCE(o.org_name, c.council_name) as organization_name,
    ...
    LEFT JOIN council c ON a.council_id = c.id
...
<head>
    ...
    <style>
        ...
        .filter-section .btn-secondary:active {
            border: none !important;
            outline: none !important;
        }
        
        /* Award cards alternating colors */
        ...
        .row .col-md-6:nth-child(even) .bi-trophy {
            color: #6c757d;
        }
        ...
        .row .col-md-6:nth-child(even) .text-warning {
            color: #6c757d !important;
        }
    ...
    <main class="py-4">
        <div class="container-fluid">
            <div class="page-header">
                <h2 class="page-title">All Organization Awards</h2>
                <p class="page-subtitle">View and manage awards across all organizations</p>
            </div>

            <!-- Filters -->
            <div class="card filter-section mb-4">
                <div class="card-header bg-white">
                    <h3 class="card-title h5 mb-0">AWARDS FILTERS </h3>
                </div>
                <div class="card-body">
                    <form method="GET" class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="search_title" name="search_title" value="<?php echo htmlspecialchars($searchTitle); ?>" placeholder="Search award title...">
                            </div>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                            <div class="d-grid gap-2 w-100">
                                ...
                                <a href="osas_view_awards.php" class="btn btn-secondary">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div>
                                    ...
                                    <h6 class="card-subtitle text-muted mt-1">
                                        ...
                                        <?php echo htmlspecialchars($award['organization_name']); ?>
                                    </h6>
                                </div>
                            ...
                            <div class="mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <small class="text-muted">Awarded on <?php echo date('M d, Y', strtotime($award['award_date'])); ?></small>
                                </div>
                                    ...
                                    <div class="col-4">
                                        <div class="gallery-item position-relative" data-award-id="<?php echo $award['id']; ?>" data-image-index="<?php echo $index; ?>" title="View full image">
                                            <img src="<?php echo htmlspecialchars($image['image_path']); ?>" 
                                                 ...
                                                 alt="Award Image <?php echo $index + 1; ?>"
                                            ...
                                            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center gallery-item" 
                                                 style="background: rgba(0, 0, 0, 0.7); cursor: pointer; border-radius: 12px;"
                                                 data-award-id="<?php echo $award['id']; ?>" data-image-index="<?php echo $index; ?>">
    ...
    <script>
        class ImageGallery {
            ...
            async openGallery(awardId, startIndex = 0) {
                ...
                try {
                    // Fetch all images for this award
