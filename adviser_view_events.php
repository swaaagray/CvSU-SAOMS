...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['action']) && isset($_POST['doc_id'])) {
        ...
        // Verify the document belongs to an event in this adviser's organization
        $stmt = $conn->prepare("
            SELECT ed.*, e.organization_id 
            FROM event_documents ed
            JOIN events e ON ed.event_id = e.id
            WHERE ed.id = ? AND e.organization_id = ?
        ");
        $stmt->bind_param("ii", $docId, getCurrentOrganizationId());
        $stmt->execute();
...
$query = "
    ...
    WHERE e.organization_id = ? AND $statusCondition
";
...
<head>
    ...
    <title>View Events - Organization Adviser</title>
...
<body class="bg-light">
    ...
    <main class="py-4">
        <div class="container-fluid">
            <div class="page-header">
                <h2 class="page-title">Organization Events</h2>
                <p class="page-subtitle">View and manage your organization's events</p>
            </div>
                    ...
                    <form method="GET" class="row g-3">
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                            <div class="d-grid gap-2 w-100">
                                ...
                                <a href="adviser_view_events.php" class="btn btn-secondary">
    ...
    <div class="modal fade" id="eventDocsModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="eventDocsModalTitle">Organization Event Documents</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
    ...
    <div class="modal fade" id="approveEventDocModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Approve Organization Event Document</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
    ...
    <div class="modal fade" id="rejectEventDocModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Reject Organization Event Document</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
    ...
    <script>
        ...
        document.getElementById('eventDocsModal').addEventListener('show.bs.modal', function(event) {
            ...
            document.getElementById('eventDocsModalTitle').textContent = 'Organization Event Documents';
            ...
            fetch(`get_organization_event_documents.php?approval_id=${eventId}`)
