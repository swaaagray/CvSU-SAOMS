...
if (!$councilId) {
    echo '<div class="alert alert-danger">No council found for this president.</div>';
    exit;
}
...
// Get the most recent bylaws document only (from council_documents table)
$stmt = $conn->prepare("
    ...
    WHERE cd.council_id = ? AND cd.document_type = 'constitution_bylaws' AND cd.osas_approved_at IS NOT NULL AND at.status = 'active'
    ...
    <main>
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>By-Laws Documents</h2>
                <div class="d-flex align-items-center">
                    <span class="badge bg-secondary me-2">Council: <?php echo htmlspecialchars($council['council_name']); ?></span>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="card">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted">The council has not uploaded any bylaws document yet.</p>
                        <div class="alert alert-info mt-3">
                            <i class="bi bi-info-circle me-2"></i>
                            <strong>Note:</strong> Only the most recent bylaws document is displayed here. 
                            Document history is not shown to council presidents.
                        </div>
                    </div>
                </div>
            <?php endif; ?>
